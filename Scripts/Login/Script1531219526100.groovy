...
'Login the user'
WebUI.click(findTestObject('Page_Showhub - 2PointRalph/a_Log in'))

'Input email address which is blocked'
WebUI.setText(findTestObject('Page_Showhub - 2PointRalph/input_userEmail'), 'kiru.chennimalai@freemanco.com')

'Enter password'
WebUI.setText(findTestObject('Page_Showhub - 2PointRalph/input_password'), 'Crazyplant86')

'Click \'Login\' button'
WebUI.click(findTestObject('Page_Showhub - 2PointRalph/button_Log in'))

String errorMsg = WebUI.getText(findTestObject('Page_Showhub - 2PointRalph/div_Your account has been bloc'))
...
WebUI.setText(findTestObject('Page_Showhub - 2PointRalph/input_userEmail'), 'kiru.chennimalai+1@freemanco.com')

'Enter a wrong password'
WebUI.setText(findTestObject('Page_Showhub - 2PointRalph/input_password'), 'password123')

'Click \'Login\' button'
WebUI.click(findTestObject('Page_Showhub - 2PointRalph/button_Log in'))

String errorMsg1 = WebUI.getText(findTestObject('Page_Showhub - 2PointRalph/div_Wrong email or password.'))
...
WebUI.setText(findTestObject('Page_Showhub - 2PointRalph/input_userEmail'), 'kiru.')
...
String errorMsg2 = WebUI.getText(findTestObject('Page_Showhub - 2PointRalph/div_Please enter valid usernam'))
...
WebUI.click(findTestObject('Page_Showhub - 2PointRalph/a_Forgot the password'))

'Input invalid email address'
WebUI.setText(findTestObject('Page_Showhub - 2PointRalph/input_userEmail'), 'kiru')

'Click \'submit\' button'
WebUI.click(findTestObject('Page_Showhub - 2PointRalph/button_Submit'))

String successMsg = WebUI.getText(findTestObject('Page_Showhub - 2PointRalph/div_Please enter a valid email'))
...
String successMsg1 = WebUI.getText(findTestObject('Page_Showhub - 2PointRalph/div_You have successfully subm'))
...
if (WebUI.verifyElementPresent(findTestObject('Page_Showhub - 2PointRalph/span_Show'), 10)) {
